...
describe('Register.vue', () => {
  ...
  test('should have an errors computed property', () => {
    ...
    expect(errorsUpdated.password).toBeUndefined();
    expect(errorsUpdated.birthYear).toBeUndefined();
  });
  ...
  test('should update the dirtiness of a field', () => {
    ...
    expect(dirty.login).toBe(false);
    expect(dirty.password).toBe(false);
    expect(dirty.birthYear).toBe(false);
